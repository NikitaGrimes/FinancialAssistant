...
public class ScheduledPayDB {
    ...
    public ScheduledPayDB() {

    }

    public ScheduledPayDB(int _id, long _type_of_exp_id, int _value, int _realValue, long _cur_id, long _acc_id, GregorianCalendar _date) {
        this.id = _id;
    ...
    public ScheduledPayDB(long _type_of_exp_id, int _value, int _realValue, long _cur_id, long _acc_id, GregorianCalendar _date) {
        this.type_of_exp_id = _type_of_exp_id;
        this.value = _value;
        this.realValue = _realValue;
        this.currents_id = _cur_id;
